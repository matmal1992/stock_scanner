# profiles.py
from stock_scanner.download.config import CONFIG_1D, CONFIG_5M, CONFIG_15M
from stock_scanner.strategies.three_tier_scanner.config_filters import (
    T1_FILTER,
    T2_FILTER,
    T3_FILTER,
)
from stock_scanner.strategies.three_tier_scanner.strategy_profiles import (
    T1_COLUMNS,
    T2_COLUMNS,
    T3_COLUMNS,
    metrics_t1,
