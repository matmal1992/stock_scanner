...
def main():
    ...
    run_download(CONFIG_1D, "<!-- T1_DOWNLOAD -->", "first", use_check=True)

    print("\n===== ETAP 2: ANALIZA first tier tickers =====")
    run_scan(PROFILE_T1)

    print("\n===== STAGE 3: DOWNLOAD second tier tickers =====")
    run_download(CONFIG_15M, "<!-- T2_DOWNLOAD -->", "second", use_check=False)

    print("\n===== ETAP 4: ANALIZA 2nd tier tickers =====")
    run_scan(PROFILE_T2)

    print("\n===== STAGE 5: DOWNLOAD third tier tickers =====")
    run_download(CONFIG_5M, "<!-- T3_DOWNLOAD -->", "third", use_check=False)
